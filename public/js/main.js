...
DRF.twitter = function(){
	...
	if($('.twitter-list').length > 0){
		...
		$(".twitter-list").each(function(){
			...
			$(this).tweet({
				join_text: '',
				username: "DormRoomFund", // your Twitter ID
...
DRF.toolTip = function(){ 
    $('a[data-toggle=tooltip]').tooltip('show').tooltip('toggle');
}
...
$(document).ready(function(){
    ...
    $('.tp-caption.innerlink.bindit, .binding-link').bind('click', function(e) {
        e.preventDefault();
